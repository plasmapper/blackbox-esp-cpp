...
## [2.2.1] - 2026-08-28
### Fixed
- BlackBox::defaultHardwareInfoNvsNamespaceName and defaultGeneralConfigurationNvsNamespaceName static initialization order dependency.
- BlackBox::LoadAllConfigurations, SaveAllConfigurations and EraseAllConfigurations holding BlackBox::mutex across each configuration's callback.

## [2.2.0] - 2026-08-27
### Added
- Virtual destructors to BlackBox and BlackBoxConfiguration.
- static_asserts verifying BlackBoxModbusServer's MemoryData layout against the documented register map.

### Changed
- BlackBoxConfiguration to be non-copyable.
...
- BlackBoxModbusServer register handlers locking BlackBox and copying its configuration vectors twice per request.

## [2.1.1] - 2026-08-20
### Fixed
- Out-of-bounds read in HardwareInterfaceConfigurationHR::OnWrite Wi-Fi password validation.
...
- Dead return statement after BlackBox::Restart's call to esp_restart.
